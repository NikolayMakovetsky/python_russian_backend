...
УРОВНИ "КРИТИЧНОСТИ" ТЕХ СОБЫТИЙ, КОТОРЫЕ МЫ ХОТИМ ЗАЛОГИРОВАТЬ:
При выборе уровня логируется он и все, что находится "выше" по иерархии
Например, при уровне ERROR, пользователю будут выводиться на экран
только сообщения категорий ERROR - CRITICAL
